...
/**
 * Home object for domain model class Registry.
 * @see strutsbase.Registry
 * @author Hibernate Tools
 */
public class RegistryHome {

	private static final Log log = LogFactory.getLog(RegistryHome.class);
	...
	public void persist(Registry transientInstance) {
		log.debug("persisting Registry instance");
		try {
	...
	public Registry merge(Registry detachedInstance) {
		...
		try {
			Registry result = (Registry) sessionFactory.getCurrentSession()
	...
	public Registry findById(java.lang.Integer id) {
		...
		try {
			Registry instance = (Registry) sessionFactory.getCurrentSession()
					.get("strutsbase.Registry", id);
			if (instance == null) {
	...
	public List findByExample(Registry instance) {
		log.debug("finding Registry instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("strutsbase.Registry")
